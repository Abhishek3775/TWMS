...
export default function SalesOrdersPage() {
  ...
  const buildPayload = (header: Record<string, unknown>, items: LineItem[]): CreateSalesOrderDto => ({
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ['sales-orders'] });
      setDeleting(null);
      toast.success('Order deleted / cancelled');
    },
    onError: (e: { response?: { data?: { error?: { message?: string } } } }) =>
  ...
  return (
    <div>
      ...
      <OrderFormDialog
        ...
        initialData={editing ? { ...editing, so_number: editing.so_number } : undefined}
