  ...
  const createMutation = useMutation({
    mutationFn: () => {
      const payload: CreateSalesReturnDto = {
        ...
        return_reason: formReturnReason || 'Return',
        notes: formNotes || undefined,
        items: formItems.filter((i) => i.product_id).map((i) => ({
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={!formCustomerId || !formWarehouseId || !formReturnReason || formItems.every((i) => !i.product_id) || createMutation.isPending}
            >
